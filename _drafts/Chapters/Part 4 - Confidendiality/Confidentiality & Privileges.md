...
a. Generally known information. Confidential client information does
...
1. To execute the will as drafted, hoping to replace it soon. In this
...
![Picture #5](../assets/img/img_0005.png)
:::
---
lang: en
...
![Picture #6](../assets/img/img_0006.png)
:::
...
Funa. "Confidential communications between an attorney and his client
...
1. Why did the court hold that the attorney-client privilege superseded
the criminal law requiring Beige to disclose the location of the
victim's body? Do you agree?

1. What if Garrow had not been convicted of any other crime? Would the
attorney-client privilege have prevented Beige from disclosing the
location of the victim's body indefinitely?

1. What if Beige had reason to believe the victim was still alive?
...
1. The remaining questions, which pertain to documents and files, can
...
1. Why did the court found that the identity of a client is not
privileged? Do you agree?

1. Why did the court find that pre-existing documents provided to
...
(a. Except as provided by DR 4-101(C) and (D), a lawyer shall not
knowingly:

(1. Reveal a confidence or secret of his client.

(1. Use a confidence or secret of his client to the disadvantage of
the client.

(1. Use a confidence or secret of his client for the advantage of
...
1. Why did the court hold that the information at issue is covered by
...
1. for the purpose of obtaining or providing legal assistance for the
client.
---
lang: en
...
1. whom the client or prospective client consults for the purpose of
...
1. Can Jenkins effectively provide legal advice to the prisoners if
...
1. If Jones had been speaking to hired or appointed counsel, would the
...
1. How many times have you met with him in person?

1. Would you recognize him if you saw him again?

1. Did you (or someone from your office) prepare Exhibits 1-5 [the INS
documenta. at his request?

1. Is the photograph on Exhibits 1 and 2 a true likeness of John Doe?

1. Did you witness John Doe sign his name on Exhibits 1-5?

1. If not, do you know who, if anyone, witnessed the signature?
...
(a. A lawyer may reveal, and to the extent required by Rule 3.3, Rule
...
Upon careful in camera review of Mr. Michaua. e-mail, the Court is not
...
1. When is a communication with an agent of an organization not
privileged?

1. Is the Upjohn test for corporate privilege too narrow, too broad, or
just right?
...
---
lang: en
title: "The "Need to Knoa. Standard Summary:"
---
...
1. How demanding is the "need to know" standard?

1. When does an agent of an organization fail to satisfy the "need to
know" standard?
---
lang: en
...
a. Statements made by Ms. Elliott to Medco Defendants' counsel
regarding her conversations with Government investigators;

a. Descriptions and/or summaries of witness testimony provided to Ms.
Elliott by counsel for Medco Defendants; and

a. Conversations between counsel for Medco Defendants and Ms. Elliott
...
a. they are otherwise discoverable under Rule 26(b)(1); and

ia. the party shows that it has substantial need for the materials to
...
a. a written statement that the person has signed or otherwise adopted
or approved; or

ia. a contemporaneous stenographic, mechanical, electrical, or other
...
![Picture #7](../assets/img/img_0007.png)
:::
...
1. How does the justification for the work product doctrine differ from
the justification for the attorney-client privilege?

1. How does the protection provided by the work product doctrine differ
from the protection provided by the attorney-client privilege?

1. Why didn't plaintiff's counsel make a sufficient showing of
...
::: {style="width: 76.66666666666667%;"}
![Picture #8](../assets/img/img_0008.png)
:::
...
![Picture #9](../assets/img/img_0009.png)
:::
...
1. Why is the standard for discovery of fact work product lower than
the standard for opinion work product?

1. Should opinion work product ever be discoverable? What if it is
inextricable from fact work product?

1. How would discoverability of fact or opinion work product affect the
incentives of attorneys?

::: {style="width: 62.94117647058823%;"}
![Picture #10](../assets/img/img_0010.png)
:::
...
::: {style="width: 62.94117647058823%;"}
![Picture #11](../assets/img/img_0011.png)
:::
...
1. Why did the dissent argue that it was not work product at all?
...
encourage the sort of "inefficiency, unfairness and sharp practicea.
...
1. When would a document disclosed to a third-party not be protected by
...
ia. describe the nature of the documents, communications, or tangible
...
1. the disclosed and undisclosed communications or information concern
the same subject matter; and




1. they ought in fairness to be considered together.

a. Inadvertent Disclosure. When made in a federal proceeding or to a
federal office or agency, the disclosure does not operate as a waiver in
a federal or state proceeding if:

1. the disclosure is inadvertent;

1. the holder of the privilege or protection took reasonable steps to
prevent disclosure; and

1. the holder promptly took reasonable steps to rectify the error,
including (if applicable) following Federal Rule of Civil Procedure
26(b)(5)(B).

a. Disclosure Made in a State Proceeding. When the disclosure is made
...
1. is not a waiver under the law of the state where the disclosure
occurred.

a. Controlling Effect of a Court Order. A federal court may order that
...
a. Controlling Effect of a Party Agreement. An agreement on the effect
...
a. Controlling Effect of This Rule. Notwithstanding Rules 101 and 1101,
...
![Picture #12](../assets/img/img_0012.png)
:::
...
![Picture #13](../assets/img/img_0013.png)
:::
...
::: {style="width: 76.66666666666667%;"}
![Picture #14](../assets/img/img_0014.png)
:::
...
(1. prepared in anticipation of litigation or for trial, and (3)
